    ...
    <>
          ...
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 bg-[#EBA224] hover:bg-[#d8921b] text-black px-4 py-2 rounded-full text-xs font-bold tracking-tight shadow-sm transition cursor-pointer shrink-0 min-h-[38px] active:scale-95"
              >
                <Plus className="w-4 h-4 stroke-[3]" />
                <span>+ Naya Estimate</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-black/95 backdrop-blur-md border-t border-neutral-800 shadow-2xl py-1 px-1">
        <div className="flex items-center justify-around max-w-md mx-auto">
          <button
            onClick={() => setActiveTab('dashboard')}
            className={`flex flex-col items-center justify-center min-w-[60px] min-h-[44px] py-1 px-2 rounded-xl transition cursor-pointer ${
              activeTab === 'dashboard'
          ...
          >
            ...
            <span className="text-[10px] font-semibold">Labour</span>
          </button>
